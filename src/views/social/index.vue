      ...
      <el-card class="hr-block">
        <el-table :data="list"
          ...
          <el-table-column prop="leaveTime"
                           ...
                           align="center"
                           sortable />
          <el-table-column prop="participatingInTheCity"
                           align="center"
                           label="社保城市" />
          <el-table-column prop="providentFundCity"
                           align="center"
                           label="公积金城市" />
          <el-table-column prop="socialSecurityBase"
                           align="center"
                           label="社保基数" />
          <el-table-column prop="providentFundBase"
                           align="center"
                           label="公积金基数" />
          <el-table-column label="操作"
            ...
            <template v-slot:default="obj">
              <el-button type="text"
                         size="mini"
                         @click="$router.push(`/social_securitys/detail/${obj.row.id}`)">查看详情</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-row type="flex"
