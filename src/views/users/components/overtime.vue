    ...
    <div>
      <el-form ref="ruleForm"
        ...
        <el-form-item label="加班开始时间"
                      prop="timeValue">
          <el-date-picker v-model="ruleForm.data.start_time"
        ...
        <el-form-item label="加班结束时间"
                      prop="timeValue">
          <el-date-picker v-model="ruleForm.data.end_time"
                          type="date"
                          format="yyyy-MM-dd HH:mm:ss"
                          placeholder="选择日期"
                          :disabled="computeOpType" />
        ...
        <el-form-item label="申请原因"
                      prop="evaluate">
          <el-input v-model="ruleForm.data.reason"
                    type="textarea"
                    style="width: 400px;"
        ...
        <div class="buttones"
          ...
          <el-form-item>
            <el-button v-show="(ruleForm.state == 0 || ruleForm.state == 1) && tabLab =='launch'"
                       type="primary"
                       @click="btnClick">撤销</el-button>
            <el-button v-show="(ruleForm.state == 0 || ruleForm.state == 1) && tabLab =='approvals'"
                       type="primary"
                       @click="btnPass">通过</el-button>
            <el-button v-show="(ruleForm.state == 0 || ruleForm.state == 1) && tabLab =='approvals'"
                       type="primary"
                       @click="btnReject">驳回</el-button>
            <!-- </el-form-item> -->
            <el-button v-show="ruleForm.stateOfApproval == 4 && tabLab =='launch'"
                       type="primary"
                       @click="btnSave">提交</el-button>
          </el-form-item>
        </div>
      </el-form>
    </div>
